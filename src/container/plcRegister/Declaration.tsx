...
import {
    getFormDetails, postFormUpload,
    putFormUpload,
} from "../../api-service/api/PlcApi";
    ...
    const Submit = async (e: any) => {
        ...
        const payload = {
            basicDetails: {
                ...
                // pincode: {
                // value : formData?.setSearchData._id,
                // label : formData?.setSearchData.pincode,
                // } ,
            },
        ...
        try {
            if (profileData?.formCompleted === true && profileData?.formStatus === "rejected") {
                ...
                if (updateApi?.status === 200) {
                    toast.success("PLC Application Updated Form Subimitted");
                ...
                if (uploadApi?.status === 200) {
                    toast.success("PLC Application Form Subimitted SuccessFully..!");
                    setOpenApporval(true);
                }
            }
        } catch (error) {
