...
import NavButtons from "../plcRegister/NavButtons";
import {
    setCurrentPage,
    updateFormData,
} from "../../redux/slices/plcRegister";
...
function BasicInformation({ }: Props) {
    ...
    useEffect(() => {
        ...
        if (allFormDetails) {
            ...
            setValue("channelName", allFormDetails?.channelName);
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} className="my-5 mx-[4%] md:mx-[8%]">
                ...
                <div className="font-poppins">
                    ...
                    <div className="border-[1px] border-[#DFDFDF] rounded-sm mt-5 ">
                        ...
                        <div className="grid-cols-12 grid gap-5 p-4">
                            ...
                            <div className="col-span-12  md:col-span-6 ">
                                <div className="font-medium text-sm">
                                    Channel Name<span className="text-red-400 ms-1">*</span>
                                </div>
                                <div className="mt-1">
                                    <input
                                        id="channelName"
                                    ...
                                    {errors.channelName && (
                                        <p className="text-red-400 text-xs mt-1 font-medium">
                                            {getErrorMessage(errors.channelName)}
                                        </p>
                                    )}
                                </div>
                            </div>
                ...
                <Modal.Body className="bg-white rounded-lg py-5 relative text-center">
                    <div className="flex flex-col  justify-center ">
                        ...
                        <p className="text-[#444444] text-xs mt-2">
                            Complete the Private Local Channel form to enjoy an
