...
import "./OtpModal.css"
import { mobileOTPSignupPlc } from "../../../api-service/api/authApi";
import toast from "react-hot-toast";
import OtpVerifyModal from "./OtpVerifyModal";
import { MdCancel } from "react-icons/md";


function PlcOtpSendModal({isOpenModal,toggle} : any) {
    ...
    const {
      ...
      const mobileSend = async (data : any) => {
        ...
        setMobile(data.mobile)
            ...
            const mobileStatus = await mobileOTPSignupPlc(payload);
            if (mobileStatus) {
            ...
            <div className="flex flex-col  justify-center ">
                ...
                {...register("mobile")}
                 ...
                 onInput={(e) => {
                  ...
                  maxLength={10} />
                 {errors.mobile && <p className='text-red-600 text-xs mt-1 font-medium'>{errors.mobile.message}</p>}
...
export default PlcOtpSendModal