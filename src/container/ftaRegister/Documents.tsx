...
import { setCurrentPage, updateFormData } from '../../redux/slices/ftaRegister';
    ...
    const handleUploadPassportPhoto = async (e: any) => {
        ...
        if (e.target.files) {
            ...
            if (!allowedFileTypes.includes(file.type)) {
                setLicenseImgUrlError("Only JPG, PNG, or PDF files are allowed.");
                ...
                <div className='font-poppins'>
                    ...
                    <div className='border-[1px] border-[#DFDFDF] rounded-sm grid grid-cols-12 gap-5 mt-4 py-3 px-2'>
                        <div className='col-span-12 md:col-span-6 lg:col-span-3 border-[1px] border-[#DFDFDF] rounded-sm w-full'>
                                ...
                                (
                                    <>
                                        {passportUrlLoading ? (
                                            ...
                                            <>
                                                {licenseImgUrl && (
                                                    <div className=" h-52 cursor-pointer my-3 w-[90%] flex justify-center  mx-auto">
                            ...
                            {licenseImgUrlEror && <p className='text-red text-xs  font-medium mx-4'>{licenseImgUrlEror}</p>}
