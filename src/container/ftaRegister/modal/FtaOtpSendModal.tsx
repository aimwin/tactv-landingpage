...
import "./OtpModal.css"
import { mobileOTPSignupFta } from "../../../api-service/api/authApi";
import toast from "react-hot-toast";
import OtpVerifyModal from "./OtpVerifyModal";
import { MdCancel } from "react-icons/md";


function FtaOtpSendModal({isOpenModal,toggle} : any) {
    ...
    const {
      ...
      const mobileSend = async (data : any) => {
        ...
        setMobile(data.mobile)
            ...
            const mobileStatus = await mobileOTPSignupFta(payload);
            if (mobileStatus) {
...
export default FtaOtpSendModal