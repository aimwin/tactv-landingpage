...
import BasicInformation from "../ftaRegister/BasicInformation";
import Declaration from "../ftaRegister/Declaration";
import Documents from "../ftaRegister/Documents";
...
import { resetFormData, setCurrentPage } from "../../redux/slices/ftaRegister";

const FtaRegistration = () => {
        ...
        ${i + 1 < currentPage ? "text-white" : "text-gray-500"}`}
            ...
            <div className="font-poppins bg-[#914d1c26] flex items-center justify-between px-[4%] py-2">
                <div className="md:flex md:items-center">
                    <h2 className="uppercase text-xl font-bold ">FTA Application form</h2>
                    <h2 className="md:ms-2 text-xs md:text-sm text-[#914D1C]">{formattedDate}</h2>
                </div>
                <div className="flex items-center">
                    <p className="">வணக்கம்/welcome:</p>
...
export default FtaRegistration